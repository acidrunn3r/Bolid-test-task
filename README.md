...
* При заходе на /api/v1/events/upload-json/ выводится ошибка 405, и отсутствует форма для загрузки файла. 
  Чтобы загрузить файл, нужно послать любой невалидный запрос, и тогда появится форма.
