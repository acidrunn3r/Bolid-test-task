...
class EventFilter(FilterSet):
    temperature_min = NumberFilter(
        field_name="temperature", lookup_expr="gte", label="Minimal Temperature"
    )
    temperature_max = NumberFilter(
        field_name="temperature", lookup_expr="lte", label="Maximal Temperature"
    )
    humidity_min = NumberFilter(
        field_name="humidity", lookup_expr="gte", label="Minimal Humidity"
    )
    humidity_max = NumberFilter(
        field_name="humidity", lookup_expr="lte", label="Maximal Humidity"
    )
